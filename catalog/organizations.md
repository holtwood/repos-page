...
组织成员：holtwood、Lumkai、TideTree。**但全部 7 个仓库的代码贡献者仅为 holtwood
...
|---|---|---|---|---|
| [aicl-lab](https://github.com/open-infra-ai/aicl-lab) | Markdown | - | holtwood | 五仓作品集 landing 页与计划/面试材料唯一权威源 |
| [cuda-foundations](https://github.com/open-infra-ai/cuda-foundations) | C++ | MIT | holtwood + CI bot | L1：CUDA 算子工程学习路径（原 cuda-kernel-academy） |
| [triton-fused-ops](https://github.com/open-infra-ai/triton-fused-ops) | Python | MIT | holtwood | L2：Triton 算子库 + torch.library 注册 |
| [cuflash-attn](https://github.com/open-infra-ai/cuflash-attn) | CUDA | MIT | holtwood | L3：CUDA C++ FlashAttention 前后向（WMMA） |
| [tiny-llm](https://github.com/open-infra-ai/tiny-llm) | C++ | MIT | holtwood | L4：CUDA 原生 C++ 推理引擎（GGUF/W8A16/分页 KV） |
| [paged-infer](https://github.com/open-infra-ai/paged-infer) | Rust | MIT | holtwood | L4：PagedAttention 分页 KV + Continuous Batching 控制面 |
