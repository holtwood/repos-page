...
| 项目 | 能力信号 | 使用建议 |
|---|---|---|
| [cpp-high-performance-guide](https://github.com/holtwood/cpp-high-performance-guide) | C++20 性能工程、SIMD、内存优化、基准测试 | 辅助；内容可作面试复习材料 |
| [bitcal](https://github.com/holtwood/bitcal) | C++23、AVX2 位运算 | 低优先级 |
| [ompi](https://github.com/holtwood/ompi) | MPI/分布式通信理论学习参考 | P3，仅通信话题引用 |
